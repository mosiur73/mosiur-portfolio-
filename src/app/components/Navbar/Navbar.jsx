  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-gray-900/95 backdrop-blur-lg border-b border-gray-700/50 shadow-lg" : "bg-transparent"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            ...
            >
              ...
              <span className="text-xl font-bold ">Mosiur<span className="text-purple-500">Dev</span></span>
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="relative w-10 h-10 text-white hover:text-blue-400 focus:outline-none focus:text-blue-400 transition-colors duration-300"
            >
