  ...
  const contactInfo = [
    {
      icon: "📧",
      title: "Email",
      value: "mdmosiurrahman.nachol@gmail.com",
      link: "",
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${info.color} rounded-lg flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300`}
                    >
                      {info.icon}
                    </div>
